 ...
 */
public class GenerationalNSGeneticAlgorithm<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, S> {
   ...
   * Constructor
   */
  public GenerationalNSGeneticAlgorithm(Problem<S> problem, int maxEvaluations, int populationSize,
  ...
  @Override public String getDescription() {
    return "GenerationalNS Genetic Algorithm" ;
  }
}
