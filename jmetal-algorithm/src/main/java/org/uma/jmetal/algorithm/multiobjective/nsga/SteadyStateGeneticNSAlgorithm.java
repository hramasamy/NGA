 ...
 */
public class SteadyStateGeneticNSAlgorithm<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, S> {
   ...
   * Constructor
   */
  public SteadyStateGeneticNSAlgorithm(Problem<S> problem, int maxEvaluations, int populationSize,
  ...
  @Override public String getDescription() {
    return "Steady-State GeneticNS Algorithm" ;
  }
}
